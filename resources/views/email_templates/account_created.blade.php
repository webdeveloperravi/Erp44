                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Welcome, {{ $user ?? 'user' }}
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <small style="margin: 0;">We're excited to have you get started. your new account creds are
                                given below</small>
                        </td>
                    </tr>
                    <tr>
