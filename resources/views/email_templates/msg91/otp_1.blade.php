    ...
    <style>
        * {
        ...
        #header_org::after {
            ...
            width: 100%;
            height: 6px;
            background-image: url('https://i.ibb.co/2h7tKrb/Under-Line.png');
                                    ...
                                    <tr>
                                        <td align="center" valign="top"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" class="templateRow"
                                                ...
                                                style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
                                                <tbody>
                                                    <tr style="background: url(https://i.ibb.co/zQS6ypK/bg1.jpg);background-size:100% 100%;color:#fff"
                                                        id="center_div">
                                                        <td class="rowContainer kmFloatLeft" valign="top"
                                                            style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                                        ...
                                                                                        <td class="kmImageContent"
                                                                                            ...
                                                                                            <a href="#" target="_self"
                                                                                                ...
                                                                                                <img align="left"
                                                                                                    alt="Shop Now"
                                                                                                    class="kmImage"
                                                                                                    src="https://i.ibb.co/jfK6fq8/Gemstones.jpg"
                                                                                                    width="582"
                                                            ...
                                                            <div style="display: block;text-align:center;padding:20px">
                                                                ...
                                                                <a style="text-decoration:none">
                                                                    ...
                                                                    <div class="reset btn-gradient-1">
