<div class="card-footer p-2" style="background-color: #04a9f5">
    <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Issue Payment</h5>
 </div>
 <div class="card-body">
    <form  onsubmit="event.preventDefault();" id="createForm">
       ...
       <div class="row">
          ...
          <div class="col-md-3">
             <div class="form-group">
                <label for="parentId">From Payment Account</label>
                <select class="form-control" name="from" id="paymentModeAccountsList" onchange="getBalance(this.value)">
          ...
          <div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="UTR/Ch.Number" name="reference_number">
               </div>
          </div>
          <div class="col-md-3">
             <div class="form-group">
                <label for="parentId">To Store</label>
                <select class="js-example-basic-single col-sm-12" name="to_store" id="storesList" onchange="getStoreAccounts(this.value)">
          ...
          <div class="col-md-3">
             <div class="form-group">
                ...
                <select  class="js-example-basic-single col-sm-12"  name="to" id="accountsList"> 
