...
<div class="card" id="form">
   <div class="card-footer p-0" style="background-color: #04a9f5">
      <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Manager Stock Report</h5>
   </div>
   <div class="card-body">
      <div class="row">
            ...
            <form id="createForm" onsubmit="event.preventDefault();">
               ...
               <div class="form-group"> 
                  ...
                  <select class="form-control" onchange="getLedger(this.value)"> 
                     ...
                     <option value="{{ auth('store')->user()->id ?? "" }}">{{ auth('store')->user()->name ?? "" }}</option> 
...
<script>   
   function getLedger(id){ 
      var url = "{{ route('managerStockReport.all',['/']) }}/"+id;
   ...
   function stockTransactionDetail(id){
      var url = "{{ route('managerStockReport.details',['/']) }}/"+id;
      $.get(url,function(data){
