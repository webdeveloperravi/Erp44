...
<head>
    <meta charset="UTF-8">
    <title>Challan_{{ $ledger->voucher_number ?? "" }}</title>
...
<body>
    ...
    <div class="information">
        <table width="100%"  style="padding:0%"> 
            <tr>
                ...
                <td align="left" style="width: 100%; font-size:small">{{ $ledger->userReceipt->company_name }}</td>  
                @endif
                @if ($ledger->userReceipt->type == 'user') 
                <td align="left" style="width: 100%; font-size:small">{{ $ledger->userReceipt->name }}</td>
                @endif
            </tr> 
        </table>
    </div>
    ...
    <div class="information">
        <table width="100%"  style="padding:0%" class="custom-table"> 
            <tr>
                <td align="left" style="width:5%; font-size:small">Sr.</td>  
