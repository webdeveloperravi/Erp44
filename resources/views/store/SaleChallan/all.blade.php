@if (count($saleChallans))
        <div class="table-responsive">
           ...
           <tbody>
           @foreach ($saleChallans as $challan)
             ...
             <td> @if ($challan->userIssue->type == 'user')
                     ...
                     @endif</td>  
             <td>  @if (in_array($challan->userReceipt->type,$storeUserTypesAll))
                     ...
                     <td> <div class="dropdown-inverse dropdown open">
                      <button class="btn btn-sm btn-inverse  dropdown-toggle waves-effect waves-light " type="button" id="dropdown-7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
<i class="fa fa-print"></i>
             ...
             <td>
               <a href="{{ route('saleChallanUpdate.index',$challan->id) }}" class="btn btn-sm btn-warning">Edit</a>
               <a href="{{ route('saleChallan.view',$challan->id) }}" class="btn btn-sm btn-primary">View</a> 
           </td>
             </tr>
             @endforeach
         </tbody>
