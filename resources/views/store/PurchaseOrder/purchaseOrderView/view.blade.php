<div class="card"> 
    <div class="card-footer p-2" style="background-color: #04a9f5">
       <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Order Detail #{{$order->po_number}}</h5>
       <button class="d-inline float-right" onclick="($('#details').html(''))">close</button>
    </div>
 <div class="card-body">
             @if(!empty($order))
...
var cardTitle = "Order Detail #{{$order->po_number}}";
