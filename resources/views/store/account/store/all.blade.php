         ...
         <table class="table" id="table_id2" style="width:100">
            ...
            <tbody>
                ...
                <tr class="text-left"> 
                    ...
                    <td>
                     @if ($account->status == 1)
                     <button class="btn btn-success btn-sm" onclick="changeStoreAccountStatus({{ $account->id }})">Active</button>
                     @else
                     <button class="btn btn-danger btn-sm" onclick="changeStoreAccountStatus({{ $account->id }})">Inactive</button>
                     @endif
                   </td>
                    <td><a href="{{route('storeAccount.view',$account->id)}}" class="btn btn-warning btn-sm">View</a></td> 
                 </tr>
               @endforeach
            </tbody>
            <tfoot>
