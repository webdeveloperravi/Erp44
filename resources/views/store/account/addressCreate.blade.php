<div class="card" id="form">
    ...
    <div class="card-footer p-0" style="background-color: #04a9f5">
      <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Enter Address</h5>
     </div>
    <div class="card-body">
    ...
    @if(isset($store))
    <form id="addressCreateForm" onsubmit="event.preventDefault();">
      @csrf
     <div class="row">
              @csrf
    ...
    <form id="addressCreateForm" onsubmit="event.preventDefault();">
     ...
     <div class="row">
            ...
            <div class="col-xl-4 col-md-6 col-12 my-auto">
                <div class="form-group mt-lg-4"> 
                    <button class="btn btn-primary" onclick="saveStoreAddress()">Save Address</button>
                    <button class="btn btn-danger" onclick="($('#create').html(''))">Close</button>
                  </div>
            </div>  
          </div>
