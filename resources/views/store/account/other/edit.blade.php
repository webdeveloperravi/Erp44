   ...
   <div class="card-footer p-0" style="background-color: #04a9f5">
     <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Edit - {{$store->company_name}}
     </h5> 
          </div>
<div class="card-body"> 
        ...
        <div class="row">
           ...
           <div class="col col-xl-4 col-md-6 col-12 mb-1">
              <div class="form-group">
                 ...
                 <input name="company" type="text" class="form-control"  placeholder="Company Name"  value="{{$store->company_name}}" autocomplete="off"/>
              </div>
           </div>
       ...
       <div class="col-xl-4 col-md-6 col-12 mb-1 ">
           ...
           <div class="col-xl-4 col-md-6 col-12 mb-1">
              <div class="form-group">
                 ...
                 <input name="email" type="text" class="form-control"  placeholder="Email" value="{{$store->email}}" autocomplete="off" {{$store->email_verify==1 ? 'readonly' : ''}}/>
              </div>
           </div>
