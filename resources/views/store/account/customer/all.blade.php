 <div class="card">
   <div class="card-footer p-2" style="background-color: #04a9f5">
      <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Customer Accounts List</h5> 
   </div>
          ...
          <table class="table" id="table_id2" style="width:100">
             ...
             <tbody>
                 ...
                 <tr class="text-center"> 
                     ...
                     <td>{{$account->email ?? ""}}</td>
                     <td>{{$account->phone ?? ""}}</td> 
                   <td><a href="{{ route('customer.view.index',$account->id) }}" class="btn btn-warning p-1 mr-1">View</a></td> 
                  </tr>
                @endforeach
             </tbody>
             <tfoot>
 ...
 <script>
   ...
   var cardTitle = "Customer Accounts List";
