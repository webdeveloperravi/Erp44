      ...
      <div class="information">
         <table width="100%"  style="padding:0%" class="custom-table">
            <tr>
               ...
               {{-- 3 --}}
               <td align="left" style="width:16%; font-size:xx-small">Product</td>
               {{-- 4 --}}
            ...
            <tr>
               ...
               {{-- 3 --}}
               <td align="left" style="width:15%; font-size:xx-small">{{ $detail->productStock->product->name }}-{{ $detail->productStock->productGrade->alias }} </td>
               {{-- 4 --}}
            ...
            foreach ($taxes as $tax) {
               $tax = sprintf("%.2f", $tax); // $string = "0.123";
               foreach ($ledgerDetails->pluck('tax_rate') as $rate) {
                  if($tax == $rate){
                      $couting[$tax] += 1;
                  }
               }
           ...
           $final =  array_filter($couting);
            ...
            <tr >
               ...
               <td style="border:0;">Totals : </td>
               <td align="right" style="width:9%; font-size:xx-small; border:0">{{ amountFormat($ledger->product_unit_qty * $ledger->product_unit_rate) }}</td>
