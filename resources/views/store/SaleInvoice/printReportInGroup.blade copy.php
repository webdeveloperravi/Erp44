...
<html lang="en">
   ...
   <body>
      ...
      <div class="information">
         <table width="100%"  style="padding:0%" class="custom-table">
            <tr>
               ...
               <td align="right" style="width:10%; font-size:xx-small">{{ $details[$names[$i]]->sum->amount_with_discount }}</td>
               <td align="right" style="width:10%; font-size:xx-small">{{ $details[$names[$i]]->sum->discount_amount }}</td>
               <td align="right" style="width:10%; font-size:xx-small">{{ $details[$names[$i]][0]->tax_rate }}%</td>
               <td align="right" style="width:10%; font-size:xx-small">{{ $details[$names[$i]]->sum->tax_amount }}</td>
               <td align="right" style="width:10%; font-size:xx-small">{{ number_format($details[$names[$i]]->sum->mrp_without_tax,2) }}</td>
            </tr>
            @endfor 
         </table>
      </div>
      ...
      <div class="information">
         <table width="100%"  style="padding:0%">
            <td align="left" style="width:5%; font-size:xx-small"></td>
            <td align="left" style="width:10%; font-size:xx-small"></td>
            <td align="left" style="width:10%; font-size:xx-small"></td>
            <td align="right" style="width:5%; font-size:xx-small"></td> 
            <td align="right" style="width:5%; font-size:xx-small"></td> 
            <td align="right" style="width:20%; font-size:xx-small">Total Amount :</td>
            <td align="right" style="width:5%; font-size:xx-small">{{ $ledger->amount_with_discount }}</td>
            <td align="right" style="width:10%; font-size:xx-small">{{ $ledger->discount_amount }}</td>
            <td align="right" style="width:10%; font-size:xx-small"></td>
            <td align="right" style="width:10%; font-size:xx-small">{{ $ledger->tax_amount }}</td>
            <td align="right" style="width: 25%; font-size:xx-small">{{ number_format($ledger->mrp_without_tax,2) }}</td>
         </table>
      </div>
      <div class="information">
         <table width="100%"  style="padding:0%">
