    ...
    <div class="col-md-12">
       <div class="card">
          <div class="card-footer p-0" style="background-color: #04a9f5">
             <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Attach Zones To :  ({{ $store->name }})</h5>
          </div>
...
function getZones(){
    ...
    var url = "{{ route('storeDiscount.zoneAttachView') }}";
    $.ajax({
        method : "Post",
        url : url,
