...
<meta http-equiv="X-UA-Compatible" content="IE=edge" /> 
    ...
    <title>{{ warehousePageTitle() }}</title>
               ...
               <nav class="pcoded-navbar" navbar-theme="theme1" active-item-theme="theme1" sub-item-theme="theme2" active-item-style="style0" pcoded-navbar-position="fixed">
                  <div class="pcoded-inner-navbar main-menu">
                     <ul class="pcoded-item pcoded-left-item">
                        ...
                        @php   
                        if(Session::has('myModulesWarehouse') && Session::has('modulesWarehouse'))
                        {
                             $myModules = Session::get('myModulesWarehouse'); 
                             $modules = Session::get('modulesWarehouse'); 
                        }else{ 
                        ...
                        <li class="pcoded-hasmenu" id="clickNow"> 
                           ...
                           @includeWhen(count($module->sub_module) > 0,'layouts.warehouse.submodule',['modules' =>$module->sub_module,'myModules'=> $myModules])
                        </li>
                        @endif 
                        @endforeach
                     </ul>
...
$('input').focus(function() { 
       $('.form-control').removeClass('input-border-red');
});
