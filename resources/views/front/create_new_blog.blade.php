...
<body>
                    ...
                    <div @click.away="open = false" class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
                                <form method="POST" action="{{ route('9gem_blog_submit') }}"
    ...
    <div class="main mt-10">
        <div id="create_blog_container">
            <div class="head">
                <h1 class="text-5xl text-center capitalize" style="color:#c29958"> new </h1>
                <hr class="w-1/3 mx-auto mt-4 bg-black-600">
            </div>
            <div class="flex">
                            ...
                            <div class="p-6 bg-white border-b border-gray-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" id="description" rows="5"
                                        ...
                                        placeholder="write a description here..." maxlength="200"></textarea>
                                ...
                                <div style="margin:auto;padding:12px 6px 36px;max-width:960px;">
                                    ...
                                    <div class="hs-docs-content-divider">
                                        ...
                                        <textarea id="div_editor1" style="max-width: 100%" name="content"></textarea>
                                ...
                                <div class="block p-1">
                                    <select class="border-2 border-gray-300 border-relative z-50 w-50 p-2"
                                        name="action">
                                        <option class="relative z-50">Save and Publish</option>
                                        <option class="relative z-50">Save as Draft</option>
                                    </select>
                                    <button type="submit"
                                        class="pl-10 pr-10 rounded bg-blue-500 text-white hover:bg-blue-400 mt-5 p-2 w-full">Submit</button>
                                </div>
                ...
                <div class="md:w-1/6 text-left md:block hidden">
                                ...
                                <div class="form w-full rounded-lg pl-2">
                                    <label class="rounded-lg">
                                        <h2 class="text-xl pb-2"><small>Enter tags :</small> </h2><input type="text"
                                            class="tagify w-full p-2 mb-10" style="width: 100%;height: 80px;" />
                                    </label>
                                    <input type="hidden" id="vtags" name="tags" class="w-full ">
                    ...
                    <input type="radio" id="permalink" name="permalink" value="{{ request()-> }}">
                    </form>
                </div>
            </div>
