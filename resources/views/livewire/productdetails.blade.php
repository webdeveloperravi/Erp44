<div>
    <main>
                                        ...
                                        <form id="addtocardform">
                                            ...
                                            <div class="quantity-cart-box d-flex align-items-center">
                                                ...
                                                <div class="action_link ml-4">
                                                    ...
                                                    <button type="submit" class="btn btn-sqr" id="addtocartinit"
                                                        data-toggle="tooltip" data-original-title="Add to Cart">Add to
                                                        cart</button>

                                                </div>
                                                @if (session('user_login'))
                                                    <div class="action_link ml-4" style="font-size: 3rem;">
                                                        @php
                                                            $user_id = session('user_id');
                                                            $wishlishted = \App\Model\Front\Wishlist::where(['user_id' => $user_id, 'product_item_id' => $proItem['id']])->exists();
                                                        @endphp

                                                        @livewire('user-wishlist', ['item_id' =>
                                                        $proItem['id'],'wishlishted'=>$wishlishted],key('user-wishlist-786'))
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                            ...
                            @foreach ($relatedProItems as $key => $productItem)
                                @php
                                    ...
                                    <figure class="product-thumb">
                                        ...
                                        @if (session('user_login'))
                                            <div class="button-group">
                                                ...
                                                @livewire('user-wishlist', ['item_id' =>
                                                $proItem['id'],'wishlishted'=>$wishlishted],key('user-wishlist-'.$key))

                                            </div>
                                        @endif
                                        <div class="cart-hover">
                                            @livewire('add-to-cart-button', ['product_qty' =>
                                            '1','product_id'=>$proItem['id'],'price' =>
                                            $proItem['productPrice']],key('user-cart-'.$key))
        ...
        @push('scripts')
            <script>
                $('#addtocardform').on('submit', function(event) {
                    event.preventDefault();
                    var data = $(this).serialize();
                    @this.addToCartInit(data);
