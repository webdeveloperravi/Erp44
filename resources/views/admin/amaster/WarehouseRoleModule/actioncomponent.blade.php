@php 
   $role_action_ids =   App\Model\Admin\Setting\WarehouseRoleAction::where('role_id',$roleId)->pluck('action_id')->toArray();
      ...
      <h2 class="mb-0">
         <div class="row mt-2">
           ...
           <div class="col-md-11 pl-0">
            ...
            @elseif($module->action()->count() > 0)
            @includeWhen($module->sub_module->count() > 0,'admin.amaster.WarehouseRoleModule.actioncomponent',['moduleId'=>$module->id])
            @endif --}}
           </div>
         </div>
      </h2>
