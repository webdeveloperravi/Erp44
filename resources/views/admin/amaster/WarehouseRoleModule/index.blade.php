...
"><button class="btn btn-success float-left mr-5"> Back</button></a>Role Name : {{$role->name}} <a href="{{route('warehouse.role.module.edit',$role->id)}}"><button class="btn btn-primary float-right"> Edit</button></a></h3>
    ...
    <div class="card-block table-border-style">
      <div class="table-responsive"> 
          <table class="table table-styling">
            ...
            <tbody>
              @foreach($role->warehouseModules->sortBy('child_sort') as $module)
              <tr>
                <th scope="row">
                  {{$loop->iteration}}
                </th>
