...
<div class="container">
     <div class="col-md-12 col-sm-12">
        ...
        <div class="card-header text-secondary"><h2>Edit Items</h2></div>
        <div class="card-body">
        <div class="alert alert-danger alert-dismissible" style="display: none;" id="error_item">
        <button type="button" class="close" data-dismiss="alert">&times;</button>
        <ul id="res"> </ul>
        </div>
        <form method="POST" action="{{ route('items.update') }}" enctype="multipart/form-data" id="edit_item_form">
				                @csrf
        ...
        <div class="form-group row"> 
	          <div class="offset-md-1 col-sm-6 col-md-5">
	           <button type="submit" class="btn btn-info btn-block" style="margin-top:7px;"> Update</button>
	           </div>
	           <div class="col-sm-6 col-md-5">
	           	 <a href="{{ url()->previous()}}"  class="btn btn-warning btn-block" style="margin-top:7px;"> Cancel</a>
               </div>
           </div>
