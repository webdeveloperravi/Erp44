<table class="table table-bordered tbl_cut_list">
<thead>
<tr>
<th>Sr.No.</th>
<th>Name</th>
...
<td> 
<button class="btn btn-sm btn-primary p-1 " onclick="editCut({{$val->id}},'{{$val->name}}','{{$val->alias}}',`{{$val->description}}`)" style="width:auto;">edit</button>
</td>
</tr>
@endforeach
@endif
