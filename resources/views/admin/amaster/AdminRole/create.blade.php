...
<div class="container"> 
  <div class="add_config_role" style="display: none">
    <div class="card">
      ...
      <div class="card-footer p-0" style="background-color: #04a9f5">
        <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Create Admin Role</h5>
      </div>
      <div class="card-body">
  ...
  <div class="row"> 
    <div class="col">
       <button class="btn btn-dark float-right mb-3" onclick="show()">Add Admin Role</button>
     </div>
 </div> 
  <div class="card-footer p-0 mb-2" style="background-color: #04a9f5">
    <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Admin Roles</h5>
  </div> 
  <!--Role List----->
...
function editConfigRole(id) {
    ...
    var url = "{{route('admin.role.edit',['/'])}}/" + config_role_id;
...
function changeStatus(id) {
    var url = "{{route('admin.role.status.update',['/'])}}/"+id;
    $.get(url, function(data) {
        $(".success_msg").show();
...
function editModules(roleId){
     var url ="{{ route('adminRoleModule.edit',['/']) }}/"+roleId;
     $.get(url,function(data){
  ...
  function updateModules(){
      ...
      $.ajax({
          url : "{{ route('adminRoleModule.update') }}",
        method : "POST",
