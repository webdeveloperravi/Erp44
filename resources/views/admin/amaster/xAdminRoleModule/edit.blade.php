  ...
  <div class="card"> 
    ...
    <div class="card-block table-border-style">
      <div class="table-responsiv">
        <form action="{{route('admin.role.module.update')}}" method="post">
          @csrf
                ...
                <h2 class="mb-0">
                   <div class="row mt-2">
                     ...
                     <div class="col-md-10">
                      ...
                      @includeWhen($module->sub_module->count() > 0,'admin.amaster.admin_role_module.modulecomponent',['moduleId'=>$module->id])
                      @endif
                     </div>
                   </div>
                </h2>
          ...
          <a href="{{ url()->previous() }}
            " class="float-right"><button class="btn btn-danger  mt-5 mb-4 mr-5"> Cancel</button></a>
          <button class="btn btn-success mt-5 float-right mr-2 mb-4" name="submit">Update</button>
        </form>
      </div>
    </div>
  </div>
