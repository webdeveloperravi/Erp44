...
<script>
   ...
   function all(){
    ...
    var url = "{{ route('adminProfile.getAddresses',['/']) }}/"+accountId; 
   ...
   function createAddress(){
      var accountId ='{{ $accountId }}';
   var  url ="{{route('adminProfile.createAddress',['/'])}}/"+accountId;
   $.get(url,function(data){
...
function saveAddress(){
   ...
   $.ajax({
       url : "{{ route('adminProfile.updateAddress') }}",
       method : "POST",
...
var url = "{{route('adminProfile.editAddress',['/'])}}/"+id;
$.get(url,function(data){
   $("#createAddress").html(data)
...
function deleteAddress(id){
   ...
   .then((willDelete) => {
      if (willDelete) {
         var url = "{{route('adminProfile.deleteAddress',['/'])}}/"+id;
         $.get(url,function(data){
...
function editBasicInformation(){
   var url = "{{ route('adminProfile.editBasicInformation') }}";
   $.get(url,function(data){
...
function updateBasicInformation(){
   var url = "{{ route('adminProfile.updateBasicInformation') }}";
