...
<div class="card">
   <div class="card-footer p-2" style="background-color: #04a9f5">
      <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Not Issued Packet Process</h5> 
   </div>
     ...
     <div class="table-responsive">
        <table class="table" id="table_id2" style="width:100">
           ...
           <tbody>
            ...
            @else
            @if(\App\Helpers\CheckPermission::instance()->viewAction('packet-process-issue-to-manager'))
            <td> <button onclick="issueToManager({{ $packet->id }})" class="btn btn-danger">Issue To Manager</button></td>
            @else
            <td> <button onclick="noPermission()" class="btn btn-danger">Issue To Manager</button></td>
            @endif 
            @endif 
            </tr>  
         @endforeach
