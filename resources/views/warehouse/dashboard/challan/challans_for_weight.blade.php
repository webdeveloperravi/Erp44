...
@if (count($challans)) 
        ...
        <tbody>
            ...
            @if ($challan->deleted_at != null)
            <tr class="text-center">
                <td>{{$challan->super->name}}</td>
                <td>{{$challan->manager->name}}</td>
    ...
    <td></td>
    <td> 
        <label class="btn btn-danger btn-sm b-none" >Rejected</label>
    </td> 
    </tr>     
    @else 
            <tr class="text-center">
...
<div class="task-board m-0">
    ...
    <button class="btn btn-success btn-sm b-none">Weight Completed</button>
    @else
    <button class="btn btn-info btn-sm b-none">Weight Pending</button>
    @endif
