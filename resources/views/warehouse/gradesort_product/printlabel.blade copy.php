		  ...
		  <div class="panel-body"> 
			<div class="row">
			    ...
			    <div class="col-xs-4 text-right payment-details">
					<p>Invoice Number : {{ $products[0]->grade->invoiceDetail->invoice->invoice_number }}</p>
					<p>Grade : {{ $products[0]->grade->grade->grade }}</p>
					<p>Product : {{ $products[0]->grade->invoiceDetail->assign_product->name }} </p>
					<p>Product Category : {{ $products[0]->grade->invoiceDetail->product->name }} </p>
			    </div>
      ...
      <meta charset="UTF-8">
       ...
       .num{
        ...
        .con1{
          ...
          <a class="btn btn-dark" href="{{ route('barcode.Export') }}">Export Pdf</a>
