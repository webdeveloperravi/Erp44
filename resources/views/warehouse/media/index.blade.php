...
.j-tabs-container input[type="radio"]:checked + .j-tabs-label span { color:#4680ff; }
.j-tabs-container input[type="radio"]:checked + .j-tabs-label i { color:#4680ff; }
...
<div class="row" id="gemSearch">
    ...
    <div class="input-group input-group-button input-group-primary"> 
        ...
        <input  type="text" name="productNumber" onkeypress="" id='productNumber' class="form-control" placeholder="Gem ID ">
...
@section('script')
    <script>
        function searchProduct(){
            ...
            var url = "{{ route('media.create',['/']) }}/"+productNumber;
            $.get(url,function(data){
                $("#media-create").html(data);
            }); 
        }
