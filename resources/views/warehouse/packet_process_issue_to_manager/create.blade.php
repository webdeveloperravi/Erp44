 <div class="modal fade bd-example-modal-lg show" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: block;"><h5 class="modal-title">Modal title</h5>
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
       ...
       <form id="issueToManagerSave" > 
        @csrf
          <h4 class="modal-title ">Packet process Issue To Manager : </h4>
    ...
    <input id="invoice" type="text" class="form-control"  autocomplete="invoice" autofocus="" value="{{ $packet->id }}" disabled> 
    <input type="hidden" class="form-control" name="packet_id" value="{{ $packet->id }}">
               ...
               <div class="col col-sm-4 col-md-6">
               <input id="date" type="date" class="form-control" name="date" autocomplete="date" autofocus="" value="{{ now() }}">
               </div>
               </div>
