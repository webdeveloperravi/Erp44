...
<div class="md-modal modal-lg md-effect-1 md-show editModal" id="modal-1" style="width: 70%; max-width:1300px">
    <div class="md-content">
        ...
        <h5 class="text-white m-b-0 text-left" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">Packet Process Challan</h5>
        </div>
            ...
            <li>Packet No. #: &nbsp;{{ $challan->packet->number }}</li>
            ...
            <ul class="list list-unstyled text-right">
                ...
                <li>Ratti : &nbsp;{{ $challan->packet->ratti->rati_standard  }}</li> 
            </ul>
            </div>
            </div>
            </div>
