 ...
 <div>
                     ...
                     <div class="form-group">
                        ...
                        <button class="btn btn-sm btn-dark" @click="addGin()">Add</button>
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-success btn-sm" v-on:click="saveGins()">Filter Data to Preview Enteries</button>
                            </div>
                        </div>
                        </div> 
                </div>
    ...
    <!-- <h2 v-else class="text-center "><i class="fa fa-inbox "></i>&nbsp; Empty</h2>                 -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-footer p-2" style="background-color: #04a9f5">
                        <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;">  Receive Sale Return</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
               ...
               this.axios
                      ...
                      .then(response => {
                           if(response.data.validProducts){
                            swal('There is no any valid product to create Sale Return');
                         }
