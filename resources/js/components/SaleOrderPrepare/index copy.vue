        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <table class="table" id="example" style="width:100">
                 ...
                 <tbody> 
                    <tr class="text-center" v-for="(detail,index) in saleOrder.purchase_order_detail" :key="index"> 
                        <td>{{index+1}}</td> 
                        <td>{{detail.product.name}}</td>  
                        <td>{{detail.grade.grade}}</td>  
                        <td>{{ detail.ratti.rati_standard }}</td>  
                        <td>{{ detail.confirmed_qty }}</td>   
                        <td>{{ getLeftQtyToAdd(detail.id) }}</td>     
                    </tr> 
                 </tbody>
              </table>
           </div>
...
<script>   
    export default {  
        props:['saleOrder','stores','routeGetAccounts','routeSaveGins','routeGetLeftQtyToAdd','routeGetAllDetails','routeDeleteProduct','routeSave'],
        data() {
            return {  
                gin : '',
                gins:[], 
