        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-footer p-2" style="background-color: #04a9f5">
                    <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;"> Create Sale Invoice Enter Gin</h5>
                </div>
                <div class="card-body"> 
                             <div class="row">
...
<script>     
    export default {  
        props:['stores','routeSaveGins','routeGetAllDetails','routeDeleteProduct','routeSave'],
        data() {
            return { 
                gin : '',
                gins:[], 
            ...
            getAllDetails(){ 
                ...
                this.axios
                    ...
                    .then(response => ( 
                       ...
                       this.notExistProducts = response.data.notExistProductsSaleInvoice,
                       this.notInStockProducts = response.data.notInStockProductsSaleInvoice,
               ...
               this.axios
                      ...
                      .then(response => {
                           if(response.data.validProducts){
                            swal('There is no any valid product to create Sale Invoice');
                         }
