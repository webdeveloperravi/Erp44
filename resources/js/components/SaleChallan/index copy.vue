<template>
 <div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-footer p-2" style="background-color: #04a9f5">
                    <h5 class="text-white m-b-0 text-left d-inline" style="padding-top:11px; padding-bottom:11px; border-left:8px solid white; margin-left:10px; padding-left:10px;"> Create Sale Challan</h5>
                </div>
                <div class="card-body"> 
                         <div class="row">
        ...
        <div class="col-md-3 " ref="getAllDetails">
            <div class="card ">
        ...
        <!-- Valid Products -->
        <div class="col-md-12 " id="exportPdf " ref="getAllDetails">
            <div class="card ">
                    ...
                    <div class="card-body">
						...
						<div class="row">
                            ...
                            <div class="col col-xl-4 col-md-4 ">
								...
								<button class="btn btn-sm btn-inverse float-right form-control " type="button" v-on:click="saveSaleChallan()">Save</button>
                                </div>
                            </div> 
                            </div> 
                    </div>
    ...
    export default {  
        ...
        methods: {  
			getAccounts:function(){
			    	this.axios.get(`/store/sale-challan-get-accounts/${this.storeId}`)
				.then(response => { 
                    this.accountId = 0;
			...
			this.axios
				.post(`/store/sale-challan-save-gins`, {
					gins : this.gins 
					}
				)
				.then(response => ( 
     ...
     swal('Plead Add atlease 1 Product');
            ...
            getAllDetails(){ 
                let loader = this.$loading.show({
                // Optional parameters
                container: this.fullPage ? null : this.$refs.getAllDetails,
                });
                this.axios
                    .get('/store/sale-challan-get-all-details')
                    .then(response => ( 
                        
                       this.notExistProducts = response.data.notExistProductsSaleChallan,
                       this.notInStockProducts = response.data.notInStockProductsSaleChallan,
            ...
            removeProduct(index){
			 ...
			 saveSaleChallan(){
               ...
               this.axios
                      .post('/store/sale-challan-save-challan',{
            ...
            deleteProduct(id){
                let loader = this.$loading.show();
               this.axios
                    .get(`/store/sale-challan-delete-product/${id}`)
                    .then(response => (
                         this.getAllDetails()
                    ))
                    .catch(err => loader.hide())
