...
class PaymentIssueController extends Controller
{
    ...
    {     
        return view('store.Payment.PaymentIssue.index'); 
    }
    ...
    public function create()
    {
        ...
        return view('store.Payment.PaymentIssue.create',compact('paymentModes','stores')); 
    }
    ...
    {   
        if($paymentModeId == 1){
            ...
            $paymentModeAccounts = UserStore::where(['org_id' => StoreHelper::getStoreId(),'account_group_id' => $paymentModeId])->get();
        }  

        return view('store.Payment.PaymentIssue.getpaymentModeAccounts',compact('paymentModeAccounts'));
    }
    ...
    {   
        ...
        return view('store.Payment.PaymentIssue.getStoreAccountsList',compact('accounts','accountGroups','authUser'));
    }
    ...
    {      
        ...
        {  
            ...
            $ledger = PaymentIssueLedger::create([
    ...
    public function getLastTransactions($accountId)
    {
        $authUser = UserStore::find($accountId); 
                ...
                $ledgers = PaymentDaybook::where('from',$authUser->id)
                            ...
                            ;
        return view('store.Payment.PaymentIssue.getLastTransactions',compact('ledgers','authUser'));
    }
}
