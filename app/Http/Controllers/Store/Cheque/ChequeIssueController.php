...
class ChequeIssueController extends Controller
{
    public function index()
    {
        return view('store.Cheque.ChequeIssue.index');
    }
    ...
    {   
        ...
        return view('store.Cheque.ChequeIssue..create',compact('cheques','stores'));
    }
    ...
    public function all()
    {
        $authUser = auth('store')->user(); 
                ...
                $ledgers = Ledger::where('from',$authUser->id)
        ...
        return view('store.Cheque.ChequeIssue.all',compact('authUser','ledgers'));
    }
