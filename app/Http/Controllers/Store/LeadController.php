...
class LeadController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $validator = Validator::make($request->all(),[
            ...
            'email' => 'required|unique:user_store,email|unique:leads,email|unique:lead_contacts,email',
    ...
    public function update(Request $request)
    {
        ...
        $lead = Lead::find($request->leadId);
            $validator = Validator::make($request->all(),[
                'name' => 'required',
                'company' => 'required', 
                'phone' => 'required|unique:lead_contacts,phone|unique:user_store,phone|unique:leads,phone,'.$request->lead->id,
            'email' => 'required|unique:lead_contacts,email|unique:user_store,email|unique:leads,email,'.$request->lead->id,
            'whats_app' => 'required|unique:lead_contacts,whats_app|unique:user_store,whats_app|unique:leads,whats_app,'.$request->lead->id, 
    ...
    public function view($id){
       ...
       // dd($lead,auth('store')->user()->type,auth('store')->user()->id,auth('store')->user()->id,$lead->store_id);
