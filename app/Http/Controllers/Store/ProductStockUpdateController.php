...
class ProductStockUpdateController extends Controller
{
    public function index(){
        ...
        return view('store.ProductStockUpdate.index');
    }
    ...
    {    
        ...
        if($product){
            return view('store.ProductStockUpdate.view',compact('product','price','products','grades','ratties','colors','clarities','origins','shapes','treatments'));
        }else{
            return view('store.ProductStockUpdate.viewEmpty',compact('product')); 
        } 
    }
        ...
        if($product){
            ...
            if($request->productRadio == 'on'){
                ...
                if($product->wasChanged()){
                    ...
                    $product->logs()->create(['name' => $name ,'description' => $description,'created_by' => auth('store')->user()->id]);
