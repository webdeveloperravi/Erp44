...
<script>
    ...
    function getTimeline(){ 
        ...
        var url = "<?php echo e(route('productStockUpdate.getDetail',['/'])); ?>/"+gin;
    ...
    function update(){
        var url = "<?php echo e(route('productStockUpdate.update')); ?>";
        $.ajax({
            url : url,
            method:'POST',
