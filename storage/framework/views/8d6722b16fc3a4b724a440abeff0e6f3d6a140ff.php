...
<div class="row">
   ...
   <div class="col">
      <a class="btn btn-dark float-right mb-3" href="<?php echo e(route('store.openingStock.create')); ?>">Create Opening Stock</a>
   </div>
</div>
<div  id="findView"> 
                 ...
                 <tbody>
                  ...
                  <tr class="text-center">
                     <td><?php echo e($ledger->id); ?></td>
                       <td><?php echo e(Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $ledger->created_at)->isoFormat('DD-MM-YY')); ?></td> 
                       <td><?php echo e($ledger->voucher_number); ?></td>
                       <td><?php echo e($ledger->qty_total); ?></td>
                       <td><?php echo e($ledger->left_qty); ?></td> 
                       <td><?php echo e($ledger->total_amount); ?></td> 
                       <td><?php echo e($ledger->left_amount ?? 0); ?></td>
                       <td> <div class="dropdown-inverse dropdown open">
                        ...
                        <a target="_blank" class="dropdown-item waves-light waves-effect" href="<?php echo e(route('openingStock.printReport',['challanId'=>$ledger->id,'type'=> 'scan'])); ?>">Scan Sort</a>
                        <a target="_blank" class="dropdown-item waves-light waves-effect" href="<?php echo e(route('openingStock.printReport',['challanId'=>$ledger->id,'type'=> 'pgr'])); ?>">PGR Sort</a> 
                        </div>
                        </div></td>
                       <td><a class="btn btn-sm btn-inverse" href="<?php echo e(route('store.openingStock.view',$ledger->id)); ?>">View Stock</a></td> 
                     </tr>
...
<script>
  $(document).ready(function() {
   ...
   var columns = [0, 1, 2, 3, 4, 5, 6];
	// DataTable
	var authUserId = "<?php echo e(auth('store')->user()->id ?? __); ?>";
	var authUserName = "<?php echo e(auth('store')->user()->name ?? __); ?>";
	var userRole = "<?php echo e(App\Helpers\Helper::getUserRoleName() ?? __); ?>";
	var companyName = "<?php echo e(App\Helpers\Helper::getStoreName() ?? __); ?>"
...
function findOpeningStock(voucherNumber){
   var url  = "<?php echo e(route('openingStock.find',['/'])); ?>/"+voucherNumber;
